   ...
   is
      ...
      function Read_Simple_Integer
        (Value          : out Interfaces.Unsigned_64;
         Leading_Zeroes : out Natural) return Boolean with
        Pre => not Codepoint_Buffer.EOF;
      ...
      begin
         ...
         loop
            ...
            --  us to negate values safely later on.
               ...
               begin
                  if Value = 0 and then
                    Digit_Value (Codepoint_Buffer.Codepoint) = 0
                  then
   ...
   begin
      ...
      then
         ...
         declare
            Junk : Natural;
         begin
            if not Read_Simple_Integer (Exponent, Junk) then
               return False;
            end if;
         end;
      end if;
